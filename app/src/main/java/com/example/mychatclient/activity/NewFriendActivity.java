...
public class NewFriendActivity extends BaseActivity {
   ...
   private View  getItem(ChatRecordBean bean){
    ...
    private void setConfirmLisetener(Button btn, final ChatRecordBean bean) {
            ...
            public void onClick(View v) {
                ...
                new Thread(new OneTimeConn(json, new OneTimeConn.OnRespondListener() {
                    ...
                    public void onSuccess(String respond) {
                        ...
                        FriendshipDao f_dao = new FriendshipDao("wzj");
                        //保存好友信息到数据库
                        f_dao.addFriendship(data);
                        //删除 好友申请记录
                        ChatRecordDao c_dao = new ChatRecordDao("wzj");
    ...
    private void setRefuseListener(Button btn, final ChatRecordBean bean) {
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
